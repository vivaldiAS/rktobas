                    ...
                    @if($count_ready_chat > 0)
                        ...
                        <div class="card card-dashboard" style="margin-bottom:8px">
                            <div class="card-body" align="center" style="padding: 0px;">
                                <a href="../chat/{{$ready_chat->merchant_id}}" style="font-weight: bold;">{{$ready_chat->nama_merchant}}</a><br>
                ...
                <div class="col-lg-12">
                    <div class="card card-dashboard">
                        <div class="card-body">
                            ...
                            @if(!$get_toko)
                                <a href="../produk/toko[{{$merchant->merchant_id}}]">{{$merchant->nama_merchant}}</a>
                            @endif
                            ...
                            @foreach($chatting as $chatting)
                                @if(!$get_toko)
                                    @if($chatting->id_from == Auth::user()->id && $chatting->pengirim == "user")
                                    ...
                                    @elseif($chatting->id_to == $id && $chatting->pengirim == "merchant")
                            ...
                            @csrf
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button id="button_chat" type="submit" class="btn btn-primary" type="submit" style="min-width: 0; background-color:#F15743">
