                    ...
                    <div class="dalam">
                        ...
                        @if($purchase->status_pembelian == "status1" || $purchase->status_pembelian == "status1_ambil")
                            @if($count_proof_of_payment->count_proof_of_payment != 0)
                                ...
                                @else
                                <a href="#batalkan_pembelian_{{$purchase->purchase_id}}" class="btns btns-outline" data-toggle="modal" href="" style="justify-content:flex-end">
                                    <span>Batalkan</span>
                                </a>
                                @endif
                            @endif
