        ...
        <div class="container">
            <div class="d-flex mt-5 flex-md-row flex-column">
                    ...
                    <div class="preview">
                        <div class="holder-big-preview d-flex justify-content-center">
                            <div class="big-preview shadow-sm">
                                <img  id="big-preview" src="{{ asset('asset/u_file/product_image/'. $product_images[0]->product_image_name) }}" loading="lazy" alt="">
                            </div>
                        </div>
                        <div class="wrap-preview-item" id="wrap-preview-item">
                            <div class="list-preview mt-1 d-flex flex-row justify-center">
                                ...
                                <div class="list-image shadow-sm" role="button">
                                    <img src="{{ asset('asset/u_file/product_image/'. $product_image->product_image_name) }}" loading="lazy" alt="">
                                </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="info-product col-12 col-md-5 mt-5 mt-md-0">
                    ...
                    <div>
                        <span class="sold">Terjual {{ $total_terjual->count_product_purchases }}</span>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="description">
                            <p class="product-text">Berat Satuan : {{ $product->heavy }} gram</p>
                            <p class="product-text">Kategori : {{ $product->nama_kategori }}</p>
                            <p class="product-text">{{ $product->product_description }}</p>
                        </div>
                    </div>
                    <a href="/produk/toko[{{$product->merchant_id}}]">
                        <div class="mt-3 border-info-v2 d-flex gap-3 align-items-start py-3">
                            <div class="icon-store mr-3">
                                <img src="{{ URL::asset('asset/Image/store_icon.png') }}" alt="">
                            </div>
                            <div class="d-flex gap-3 flex-column">
                                <span class="info-primary">
                                    {{ $product->nama_merchant }}
                                    @if($product->on_vacation == 1)
                                        <text style="color:black; font-size:9px; font-weight:normal">(Toko Sedang Libur)</text>
                                    @endif
                                </span>
                    ...
                    <div class="border-info-v2 d-flex flex-column without-top d-flex gap-3 align-items-start py-3">
                        ...
                        <div class="sender-location d-flex gap-3">
                            <img src="{{ URL::asset('asset/Image/location.png') }}" alt="location">
                            <span class="">{{  $lokasi_toko['city'].','.$lokasi_toko['subdistrict_name'] }}</span>
                        </div>
                        <div class="sender-location d-flex gap-3">
                            <img src="{{ URL::asset('asset/Image/truk.png') }}" alt="location">
                ...
                <div class="purchase-detail col-12 col-md-4 mt-5 mt-md-0">
                    <div class="shadow-sm rounded px-3 py-3  ">
                        ...
                        <div class="d-flex mt-2 justify-content-center align-items-center">
                            <div class="col-6">
                                <div class="input-custom">
                                    ...
                                    <input name="quantity" id="quantity" value="1" disabled>
                        ...
                        <script>
                            ...
                            {
                                var set_jumlah_dipasang  = document.getElementById("quantity").value;
                                document.getElementById('jumlah_dipasang').value = parseInt(1) + parseInt(set_jumlah_dipasang);

                                if(document.getElementById('jumlah_dipasang').value <= 0){
                            ...
                            {
                                var set_jumlah_dipasang  = document.getElementById("quantity").value;
                                document.getElementById('jumlah_dipasang').value = parseInt(set_jumlah_dipasang) - parseInt(1);
                        ...
                        @if(Auth::check())
                            ...
                            @elseif($cek_alamat)
                                <div class="purchase-option">
                                    ...
                                    <label class="btns btns-outline clickable" for="tambah_produk_keranjang">
                                        +Keranjang
                                    </label>
                                    ...
                                    @csrf
                                        @if($product->on_vacation == 1)
                                            <button class="btns btns-red" disabled>
                                                Beli Sekarang
                                            </button>
                                        @else
                                            <input name="jumlah_pembelian_produk" value="1" type="number" id="jumlah_dipasang" hidden>
                                            <button id="buy_now" class="btns btns-red">
                                                Beli Sekarang
                                            </button>
                                        @endif
                                    </form>
                            ...
                            <div class="buyerSubAction">
                                ...
                                <div id="div_tambah_hapus_produk_keinginan">
                                    @if(!$cek_wishlist)
                                        ...
                                        <label id="label_tambah_produk_keinginan" class="buyerSubActionb clickable" for="tambah_produk_keinginan">
                                            <img src="{{ URL::asset('asset/Image/heartOutline.svg') }}" alt="">
                                        ...
                                        <label id="label_hapus_produk_keinginan" class="buyerSubActionb clickable" for="hapus_produk_keinginan">
                                            <img src="{{ URL::asset('asset/Image/fullHeart.svg') }}" alt="">
                                            <span class="labelSub">Wishlist</span>
                                        </label>
                        ...
                        @else
                            ...
                            <div class="buyerSubAction">
                                <a href="#signin-modal" class="buyerSubActiona" data-toggle="modal">
                                    <img src="{{ URL::asset('asset/Image/chat.svg') }}" alt="">
                                    <span class="labelSub">Chat</span>
                                </a>
                        ...
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                ...
                                <a href="../lihat_produk/{{$produk_serupa->product_id}}">
                                    ...
                                    ?>
                                    @foreach($product_images as $product_image)
                                        <img class="img-serupa" src="../asset/u_file/product_image/{{$product_image->product_image_name}}" alt="{{$produk_serupa->product_name}}" class="product-image" loading="lazy">
                                    @endforeach
            ...
            <div class="modal-body">
                ...
                <div class="form-box">
						<div class="thank-you-pop">
							<img src="../asset/Image/success.png" alt="">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="form-box">
						<div class="thank-you-pop">
							<img src="../asset/Image/success.png" alt="">
							<p>Berhasil disimpan di Wishlist!</p>
 						</div>
                </div>
            </div>
        </div>
