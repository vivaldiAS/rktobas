...
<body>
    ...
    <div class="container">
        <div class="container">
            <h1 class="text-justify">Terms and Conditions</h1>
            <p><b>Last updated June 14, 2023</b></p>    
            <p class="text-justify">
                We are Rumah Kreatif Toba ("Company," "we," "us," "our"), a company registered in Indonesia at Sitoluama, North Sumatera.
                <br>
                We operate the mobile application Rumah Kreatif Toba (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
                <br><br>
                You can contact us by email at <b>kreatiftoba@gmail.com</b> or by mail to Sitoluama, North Sumatera, Indonesia.
               <br><br>
                These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Rumah Kreatif Toba, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
                <br><br>
                We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by kreatiftoba@gmail.com, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
                <br><br>
        ...
        <div class="container">
            <ol class="text-justify">
                ...
                <h4><li>USER REPRESENTATIONS</li></h4>
                <p class="text-justify">
                ...
                <h4><li>PURCHASES AND PAYMENT</li></h4>
                <p class="text-justify">
                    We accept the following forms of payment:
                    <br><br>
                    You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in Rupiah.
                    <br><br>
                ...
                <h4><li>RETURN POLICY</li></h4>
                <p class="text-justify">
                    All sales are final and no refund will be issued.
                </p>

                <h4><li>PROHIBITED ACTIVITIES</li></h4>
                <p class="text-justify">
                ...
                <h4><li>USER GENERATED CONTRIBUTIONS</li></h4>
                <p class="text-justify">
                ...
                <h4><li>CONTRIBUTION LICENSE</li></h4>
                <p class="text-justify">
                ...
                <h4><li>GUIDELINES FOR REVIEWS</li></h4>
                <p class="text-justify">
                ...
                <h4><li>MOBILE APPLICATION LICENSE</li></h4>
                <p class="text-justify">
                    <br>
                    <b>Use License</b>
                    <br><br>
                ...
                <h4><li>SERVICES MANAGEMENT</li></h4>
                <p class="text-justify">
                ...
                <h4><li>COPYRIGHT INFRINGEMENTS</li></h4>
                <p class="text-justify">
                ...
                <h4><li>TERM AND TERMINATION</li></h4>
                <p class="text-justify">
                ...
                <h4><li>MODIFICATIONS AND INTERRUPTIONS</li></h4>
                <p class="text-justify">
                ...
                <h4><li>GOVERNING LAW</li></h4>
                <p class="text-justify">
                    These Legal Terms shall be governed by and defined following the laws of Indonesia. Rumah Kreatif Toba and yourself irrevocably consent that the courts of Indonesia shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.
                </p>
                <h4><li>DISPUTE RESOLUTION</li></h4>
                <p class="text-justify">
                    You agree to irrevocably submit all disputes related to these Legal Terms or the legal relationship established by these Legal Terms to the jurisdiction of the Indonesia courts. Rumah Kreatif Toba shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Legal Terms are entered into in the course of your trade or profession, the state of your principal place of business.
                </p>
                <h4><li>CORRECTIONS</li></h4>
                <p class="text-justify">
                    There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.
                </p>
                <h4><li>DISCLAIMER</li></h4>
                <p class="text-justify">
                ...
                <h4><li>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</li></h4>
                <p class="text-justify">
                ...
                <p class="text-justify">
                    ...
                    Indonesia
                    <br>
                    <b style="font-size: 20px">kreatiftoba@gmail.com</b>
                    </b>
                    <br>
                </p>
            </ol>
