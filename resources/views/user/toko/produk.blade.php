...
@section('breadcrumb')
<li class="breadcrumb-item active" aria-current="page">Rumah Kreatif Toba Seller</li>
@endsection
...
<div class="tab-pane fade show active" id="tab-toko" role="tabpanel" aria-labelledby="tab-toko-link">
    ...
    <a  href="./tambah_produk">
        <div class=" nav-link btn btn-outline-primary-2">
                            ...
                            <figure class="product-media">
                                <a href="./edit_produk/{{$products->product_id}}">
                                    ...
                                    @foreach($product_images as $product_image)
                                        <img class="img-serupa" src="./asset/u_file/product_image/{{$product_image->product_image_name}}" alt="Product image" class="product-image">
                                    @endforeach
                                </a>
