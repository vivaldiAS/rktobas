        ...
        <section class="content">
            <div class="container-fluid">
                <div class="col-12 warehouse pt-3">
                    ...
                    <div class="col-12">
                        <form action="{{ route('admin.accept.gallery.update', $gallery->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-7 p-0">
                                        ...
                                        <select class="form-control" id="exampleFormControlSelect1" name="jenis_produk">
                                            @foreach ($categories as $item)
                                                <option value="{{ $item->category_id }}"
                                                    @if ($gallery->category_id == $item->category_id) selected @endif>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1"
                                            name="nama_produk" value="{{ $gallery->product_name }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Expired Date</label>
                                        <input type="date" class="form-control" id="exampleInputEmail1"
                                            name="expired_date"
                                            value="{{ date('Y-m-d', strtotime($gallery->expired_at)) }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Deskripsi Produk</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="deskripsi_produk">{{ $gallery->product_description }}</textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1"
                                                    name="berat" value="{{ $gallery->heavy }}">
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="exampleInputEmail1"
                                                    name="jumlah" value="{{ $gallery->stok }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-5">
                                    ...
                                    <div class="upload-image-warehouse-box border">
                                        ...
                                        <img class="add-image-warehouse-produk" id="add-image-warehouse-produk"
                                            src="{{ asset('images/' . $gallery->image) }}" alt="" srcset="">
                                    </div>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="exampleFormControlTextarea1">Isikan Alasan
                                                        Penolakan..</label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-danger" name="tolak_produk">Tolak
                                                    Permintaan</button>
                                            </div>
                                        </div>
                                    </div>
