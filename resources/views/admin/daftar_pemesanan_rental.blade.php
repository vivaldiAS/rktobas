...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Daftar Pemesanan Rental Experience</h1>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{ $item->id }}</td>
                    <td>{{ Carbon\Carbon::parse($item->tanggal_pemesanan)->formatLocalized('%A, %d %B %Y') }}</td>
                    <td>{{ Carbon\Carbon::parse($item->tanggal_mulai_sewa)->formatLocalized('%A, %d %B %Y') }} </td>
                    <td>{{ Carbon\Carbon::parse($item->tanggal_akhir_sewa)->formatLocalized('%A, %d %B %Y') }} </td>
